...
CATALOG_SERVICE_SUBSCRIPTION_URL = 'http://127.0.0.1:8001/subscriptions/'
...
def create_click_payment_url(user_id, plan_id, price):
    ...
    payment_url = f"https://my.click.uz/services/pay?service_id={MERCHANT_SERVICE_ID}&merchant_id={MERCHANT_USER_ID}&amount={price}&return_url=http://localhost:3000/&transaction_param="
    return payment_url
